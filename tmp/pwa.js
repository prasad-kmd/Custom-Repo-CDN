if (typeof Lazy !== "function") {
    ...
    (function (e) {
        ...
        function n(e) {
            "function" == typeof e &&
                (n.lazied || t.executed
                    ? e.call(window, { type: "LOCAL_STORAGE" })
                    : t.push(e));
        }
        ...
        function o() {
            (0 == document.documentElement.scrollTop &&
                ...
                (t.execute({ type: "SCROLL" }),
                    window.removeEventListener("scroll", o));
        }

        function c() {
            t.execute({ type: "CLICK" }),
        ...
        (t.executed = !1),
            (n.lazied = localStorage.getItem(e.key) === e.value),
            (t.execute = function () {
                if (!1 === this.executed) {
                    (this.executed = !0),
                        (n.lazied = !0),
                        localStorage.getItem(e.key) !== e.value &&
                        localStorage.setItem(e.key, e.value);
                    for (let e = 0; e < this.length; e++)
                        "function" == typeof this[e] && this[e].apply(window, arguments),
                            this.splice(e, 1),
                            e--;
                }
            }),
...
(function (app) {
    ...
    navigator.serviceWorker
        .register(
            "https://raw.githubusercontent.com/prasad-kmd/Custom-Repo-CDN/main/tmp/sw.js",
            {
                scope: "/",
            }
        )
        .then((registration) => {
            ...
            groupLog(
                ["%cService Worker: Registered Successfully", "color: green"],
                logs
            );
        })
        .catch((error) => {
            groupLog(
                ["%cService Worker: Registeration Failed", "color: red"],
                ["Error:", error]
            );
        });
});
